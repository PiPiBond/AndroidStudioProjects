...
import com.example.androidsession_05.friend_list.Friend;
...
public class ChatFragment extends Fragment {
    ...
    private void loadFriendsData() {
        ...
        // 通过简单适配器调用数据
        SimpleAdapter adapter = new SimpleAdapter(view.getContext(), getData(), R.layout.item_friend, mapKey, componentId);
        // 数据可视化
